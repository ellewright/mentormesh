...
skills = [
    ...
    Skill(id=6, category=Category.MATH, title="Calculus 101", description="I'll give you a tutor lesson for Calculus 101."),
    Skill(id=7, category=Category.MUSIC, title="Voice lesson", description="Get a voice lesson from a professional Broadway singer.")
]